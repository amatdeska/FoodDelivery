...
<body>
	...
	<header class="header-section">
		<div class="header-warp">
			...
			<ul class="main-menu">
				...
				<i>
				<li><a href="display">*Display data</a></li>
			</i>
			</ul>
	...
	<section class="inter-section spad">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<p>Kami menyediakan berbagai macam makanan dan minuman yang dapat dipesan secara online. Kami juga menyediakan pula porsi makanan dalam jumlah besar untuk acara penting anda.</p>
				</div>
			</div>
		</div>
	</section>
